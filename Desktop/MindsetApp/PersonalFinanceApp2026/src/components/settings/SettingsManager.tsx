...
import { Wallet, Tag, BrainCircuit, Calendar } from "lucide-react";
...
interface SettingsManagerProps {
    initialTab?: "accounts" | "categories" | "rules" | "recurring";
}

export const SettingsManager = ({ initialTab }: SettingsManagerProps) => {
    const [activeTab, setActiveTab] = useState<"accounts" | "categories" | "rules" | "recurring">(initialTab || "accounts");
